...
<html>
<head>
<title>Launch Page: Edgar Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="edgarForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Edgar, Level 1</option>
				<option value="02">Edgar, Level 2</option>
				<option value="03">Edgar, Level 3</option>
				<option value="04">Edgar, Level 4</option>
				<option value="05">Edgar, Level 5</option>
				<option value="06">Edgar, Level 6</option>
				<option value="07">Edgar, Level 7</option>
				<option value="08">Edgar, Level 8</option>
				<option value="09">Edgar, Level 9</option>
				<option value="10">Edgar, Level 10</option>
			  </select>
        ...
        {
            $("#edgarForm").attr('action', "edgar/edgar"+ $("#level").val() +  ".php");
        });
