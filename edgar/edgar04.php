...
<html>
<head>
<title>Iconic NPC Edgar Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_edgar.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_edgar_post.css">
...
<!-- JQuery -->
  ...
  <script>
	...
	/*
	 Character() - Edgar Character Constructor
	*/
	function Character() {
    ...
    let manimal = getEdgar();
		...
		let manimalCharacter = {
			...
			"init": 1 + agilityModifier + adjustInit(birthAugur, luckModifier),
    ...
    /*getEdgar() return the statistics for the Manimal per level*/  
    function getEdgar() {
	var manimal = [
	...
	return manimal[3]; 
       ...
       let imgData = "images/edgar_character_sheet.png";
